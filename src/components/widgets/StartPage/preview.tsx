  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-12 w-lg max-[800px]:justify-start max-[800px]:gap-4 max-[585px]:flex-col max-[585px]:items-start">
        <button className="w-52 h-16 rounded-[10px] bg-main text-center text-white cursor-pointer hover:bg-blue-700 text-paragraph max-[800px]:w-40 max-[585px]:w-52 max-[585px]:h-12">
          Найти услугу
        </button>
